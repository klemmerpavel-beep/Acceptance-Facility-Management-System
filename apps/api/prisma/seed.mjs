...
const этапы = {
  "R-99": [
    ["Демонтаж", "2026-03-02", "2026-03-20", 10000],
    ["Черновая электрика", "2026-03-21", "2026-04-15", 10000],
    ["Разводка воды", "2026-04-06", "2026-04-25", 10000],
    ["Штукатурка стен", "2026-04-20", "2026-05-30", 10000],
    ["Стяжка пола", "2026-05-25", "2026-06-15", 10000],
    ["Плиточные работы", "2026-06-10", "2026-07-20", 8000],
    ["Чистовая отделка", "2026-07-15", "2026-08-15", 3500],
  ],
  "R-72": [
...
for (const [code, строки] of Object.entries(этапы)) {
  ...
  let порядок = 0;
  for (const [name, startsOn, endsOn, progress] of строки) {
    const данные = {
      order: порядок,
